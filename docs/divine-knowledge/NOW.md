...
TRAINING_NEXT|DQ-TRAIN-001D Run C/D live proof: /user/perks + /user/refills; then training-inventory planning snapshot and adapter fixture freeze
...
TRAINING_001D_LIVE|Run_A_provisional_pass|Run_B_pass_schema_semantics|Complete_Cardio_live_join_10E_5.5_5.8_5.5_5.2|user_gym_min_permission_open|ordinaryHappy_elevated_followup_open
