...
TRAINING_NEXT|resolve /user/refills boolean polarity + minimum permission discrepancy; freeze v0.1 item-mechanic registry and sanitized adapter fixtures; elevated-Happy ordinaryHappy proof remains optional strengthening
