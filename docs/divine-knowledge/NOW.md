...
TRAINING_NEXT|DQ-TRAIN-001D Run B live proof: /user/battlestats + /user/gym + active /torn/gyms row; then perks/refills/inventory and adapter fixture freeze
...
TRAINING_001D_LIVE|Run_A_provisional_pass|bars_energy_regen_live_confirmed|cooldowns_shape_live_confirmed|ordinaryHappy_elevated_followup_open
