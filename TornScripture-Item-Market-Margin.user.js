...
This changes only the funding label. Quantities, prices, cost basis, and sales are untouched.`
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .tsimm-trader-book-compact{overflow-y:auto;overflow-x:hidden;overscroll-behavior:contain;-webkit-overflow-scrolling:touch}.tsimm-trader-book-compact>.tsimm-ledger-head,.tsimm-trader-book-compact>.tsimm-trader-compact-toolbar,.tsimm-trader-book-compact>.tsimm-trader-list-compact{flex:none}.tsimm-trader-book-compact>.tsimm-trader-list-compact{min-height:auto;overflow:visible;overscroll-behavior:auto}
